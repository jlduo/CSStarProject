...
- (CGRect)_setpLoadingLabelForWidth:(CGFloat)width {
    ...
    loadingLabelFrame.origin.y = CGRectGetHeight(self.bounds) / 2.0 - CGRectGetHeight(loadingLabelFrame) / 2.0  -32;
...
- (void)showLoadingAnimationWithText:(NSString *)loadingString {
    CGPoint activityIndicatorViewCentet = CGPointMake(CGRectGetWidth(self.bounds) / 2.0 * 2 / 2.8, CGRectGetHeight(self.bounds) / 2.0-32);
    ...
    loadingLabelFrmae.origin.y = CGRectGetHeight(self.bounds) / 2.0 - CGRectGetHeight(loadingLabelFrmae) / 2.0-32;
